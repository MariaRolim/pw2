<!DOCTYPE html>
    ...
    <body>
        ...
        ?>
                ...
                <h3 class="list">CPF: <?=$linha['cpf']?></h3>
                <p class="nomeproduto">LOGRADOURO: <?=$linha['logradouro']?></p>
                <br>

                <center>
            <a class="linkform" href="detalhar_endereco.php?idendereco=<?=$linha['idendereco'];?>">Detalhar endereco</a>||    
            <a class="linkform" href="alterar_endereco.php?idendereco=<?=$linha['idendereco'];?>">Alterar endereco</a>||
            <a class="linkform" href="deletar_endereco.php?idendereco=<?=$linha['idendereco'];?>">Deletar endereco</a>
            </center><br><br>
        <?php    
            }
        ?>
